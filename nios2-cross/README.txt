...
follow these steps:
    ...
    curl http://toolchains.bootlin.com/downloads/releases/toolchains/nios2/build_fragments/nios2--glibc--stable-2021.11-1.defconfig > .config
    make olddefconfig
    make
    make sdk
