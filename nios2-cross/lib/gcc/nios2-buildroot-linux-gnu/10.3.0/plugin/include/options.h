...
enum opt_code
{
  ...
  OPT_list = 1596,                           /* -list */
  OPT_march_ = 1597,                         /* -march= */
  OPT_mbionic = 1598,                        /* -mbionic */
  OPT_mbmx = 1599,                           /* -mbmx */
  OPT_mbypass_cache = 1600,                  /* -mbypass-cache */
  OPT_mcache_volatile = 1601,                /* -mcache-volatile */
  OPT_mcdx = 1602,                           /* -mcdx */
  OPT_mcustom_fabsd_ = 1603,                 /* -mcustom-fabsd= */
  OPT_mcustom_fabss_ = 1604,                 /* -mcustom-fabss= */
  OPT_mcustom_faddd_ = 1605,                 /* -mcustom-faddd= */
  OPT_mcustom_fadds_ = 1606,                 /* -mcustom-fadds= */
  OPT_mcustom_fatand_ = 1607,                /* -mcustom-fatand= */
  OPT_mcustom_fatans_ = 1608,                /* -mcustom-fatans= */
  OPT_mcustom_fcmpeqd_ = 1609,               /* -mcustom-fcmpeqd= */
  OPT_mcustom_fcmpeqs_ = 1610,               /* -mcustom-fcmpeqs= */
  OPT_mcustom_fcmpged_ = 1611,               /* -mcustom-fcmpged= */
  OPT_mcustom_fcmpges_ = 1612,               /* -mcustom-fcmpges= */
  OPT_mcustom_fcmpgtd_ = 1613,               /* -mcustom-fcmpgtd= */
  OPT_mcustom_fcmpgts_ = 1614,               /* -mcustom-fcmpgts= */
  OPT_mcustom_fcmpled_ = 1615,               /* -mcustom-fcmpled= */
  OPT_mcustom_fcmples_ = 1616,               /* -mcustom-fcmples= */
  OPT_mcustom_fcmpltd_ = 1617,               /* -mcustom-fcmpltd= */
  OPT_mcustom_fcmplts_ = 1618,               /* -mcustom-fcmplts= */
  OPT_mcustom_fcmpned_ = 1619,               /* -mcustom-fcmpned= */
  OPT_mcustom_fcmpnes_ = 1620,               /* -mcustom-fcmpnes= */
  OPT_mcustom_fcosd_ = 1621,                 /* -mcustom-fcosd= */
  OPT_mcustom_fcoss_ = 1622,                 /* -mcustom-fcoss= */
  OPT_mcustom_fdivd_ = 1623,                 /* -mcustom-fdivd= */
  OPT_mcustom_fdivs_ = 1624,                 /* -mcustom-fdivs= */
  OPT_mcustom_fexpd_ = 1625,                 /* -mcustom-fexpd= */
  OPT_mcustom_fexps_ = 1626,                 /* -mcustom-fexps= */
  OPT_mcustom_fextsd_ = 1627,                /* -mcustom-fextsd= */
  OPT_mcustom_fixdi_ = 1628,                 /* -mcustom-fixdi= */
  OPT_mcustom_fixdu_ = 1629,                 /* -mcustom-fixdu= */
  OPT_mcustom_fixsi_ = 1630,                 /* -mcustom-fixsi= */
  OPT_mcustom_fixsu_ = 1631,                 /* -mcustom-fixsu= */
  OPT_mcustom_floatid_ = 1632,               /* -mcustom-floatid= */
  OPT_mcustom_floatis_ = 1633,               /* -mcustom-floatis= */
  OPT_mcustom_floatud_ = 1634,               /* -mcustom-floatud= */
  OPT_mcustom_floatus_ = 1635,               /* -mcustom-floatus= */
  OPT_mcustom_flogd_ = 1636,                 /* -mcustom-flogd= */
  OPT_mcustom_flogs_ = 1637,                 /* -mcustom-flogs= */
  OPT_mcustom_fmaxd_ = 1638,                 /* -mcustom-fmaxd= */
  OPT_mcustom_fmaxs_ = 1639,                 /* -mcustom-fmaxs= */
  OPT_mcustom_fmind_ = 1640,                 /* -mcustom-fmind= */
  OPT_mcustom_fmins_ = 1641,                 /* -mcustom-fmins= */
  OPT_mcustom_fmuld_ = 1642,                 /* -mcustom-fmuld= */
  OPT_mcustom_fmuls_ = 1643,                 /* -mcustom-fmuls= */
  OPT_mcustom_fnegd_ = 1644,                 /* -mcustom-fnegd= */
  OPT_mcustom_fnegs_ = 1645,                 /* -mcustom-fnegs= */
  OPT_mcustom_fpu_cfg_ = 1646,               /* -mcustom-fpu-cfg= */
  OPT_mcustom_frdxhi_ = 1647,                /* -mcustom-frdxhi= */
  OPT_mcustom_frdxlo_ = 1648,                /* -mcustom-frdxlo= */
  OPT_mcustom_frdy_ = 1649,                  /* -mcustom-frdy= */
  OPT_mcustom_fsind_ = 1650,                 /* -mcustom-fsind= */
  OPT_mcustom_fsins_ = 1651,                 /* -mcustom-fsins= */
  OPT_mcustom_fsqrtd_ = 1652,                /* -mcustom-fsqrtd= */
  OPT_mcustom_fsqrts_ = 1653,                /* -mcustom-fsqrts= */
  OPT_mcustom_fsubd_ = 1654,                 /* -mcustom-fsubd= */
  OPT_mcustom_fsubs_ = 1655,                 /* -mcustom-fsubs= */
  OPT_mcustom_ftand_ = 1656,                 /* -mcustom-ftand= */
  OPT_mcustom_ftans_ = 1657,                 /* -mcustom-ftans= */
  OPT_mcustom_ftruncds_ = 1658,              /* -mcustom-ftruncds= */
  OPT_mcustom_fwrx_ = 1659,                  /* -mcustom-fwrx= */
  OPT_mcustom_fwry_ = 1660,                  /* -mcustom-fwry= */
  OPT_mcustom_round_ = 1661,                 /* -mcustom-round= */
  OPT_meb = 1662,                            /* -meb */
  OPT_mel = 1663,                            /* -mel */
  OPT_mfast_sw_div = 1664,                   /* -mfast-sw-div */
  OPT_mglibc = 1665,                         /* -mglibc */
  OPT_mgpopt = 1666,                         /* -mgpopt */
  OPT_mgpopt_ = 1667,                        /* -mgpopt= */
  OPT_mgprel_sec_ = 1668,                    /* -mgprel-sec= */
  OPT_mhw_div = 1669,                        /* -mhw-div */
  OPT_mhw_mul = 1670,                        /* -mhw-mul */
  OPT_mhw_mulx = 1671,                       /* -mhw-mulx */
  OPT_mmusl = 1672,                          /* -mmusl */
  OPT_mno_cache_volatile = 1673,             /* -mno-cache-volatile */
  OPT_mno_custom_fabsd = 1674,               /* -mno-custom-fabsd */
  OPT_mno_custom_fabss = 1675,               /* -mno-custom-fabss */
  OPT_mno_custom_faddd = 1676,               /* -mno-custom-faddd */
  OPT_mno_custom_fadds = 1677,               /* -mno-custom-fadds */
  OPT_mno_custom_fatand = 1678,              /* -mno-custom-fatand */
  OPT_mno_custom_fatans = 1679,              /* -mno-custom-fatans */
  OPT_mno_custom_fcmpeqd = 1680,             /* -mno-custom-fcmpeqd */
  OPT_mno_custom_fcmpeqs = 1681,             /* -mno-custom-fcmpeqs */
  OPT_mno_custom_fcmpged = 1682,             /* -mno-custom-fcmpged */
  OPT_mno_custom_fcmpges = 1683,             /* -mno-custom-fcmpges */
  OPT_mno_custom_fcmpgtd = 1684,             /* -mno-custom-fcmpgtd */
  OPT_mno_custom_fcmpgts = 1685,             /* -mno-custom-fcmpgts */
  OPT_mno_custom_fcmpled = 1686,             /* -mno-custom-fcmpled */
  OPT_mno_custom_fcmples = 1687,             /* -mno-custom-fcmples */
  OPT_mno_custom_fcmpltd = 1688,             /* -mno-custom-fcmpltd */
  OPT_mno_custom_fcmplts = 1689,             /* -mno-custom-fcmplts */
  OPT_mno_custom_fcmpned = 1690,             /* -mno-custom-fcmpned */
  OPT_mno_custom_fcmpnes = 1691,             /* -mno-custom-fcmpnes */
  OPT_mno_custom_fcosd = 1692,               /* -mno-custom-fcosd */
  OPT_mno_custom_fcoss = 1693,               /* -mno-custom-fcoss */
  OPT_mno_custom_fdivd = 1694,               /* -mno-custom-fdivd */
  OPT_mno_custom_fdivs = 1695,               /* -mno-custom-fdivs */
  OPT_mno_custom_fexpd = 1696,               /* -mno-custom-fexpd */
  OPT_mno_custom_fexps = 1697,               /* -mno-custom-fexps */
  OPT_mno_custom_fextsd = 1698,              /* -mno-custom-fextsd */
  OPT_mno_custom_fixdi = 1699,               /* -mno-custom-fixdi */
  OPT_mno_custom_fixdu = 1700,               /* -mno-custom-fixdu */
  OPT_mno_custom_fixsi = 1701,               /* -mno-custom-fixsi */
  OPT_mno_custom_fixsu = 1702,               /* -mno-custom-fixsu */
  OPT_mno_custom_floatid = 1703,             /* -mno-custom-floatid */
  OPT_mno_custom_floatis = 1704,             /* -mno-custom-floatis */
  OPT_mno_custom_floatud = 1705,             /* -mno-custom-floatud */
  OPT_mno_custom_floatus = 1706,             /* -mno-custom-floatus */
  OPT_mno_custom_flogd = 1707,               /* -mno-custom-flogd */
  OPT_mno_custom_flogs = 1708,               /* -mno-custom-flogs */
  OPT_mno_custom_fmaxd = 1709,               /* -mno-custom-fmaxd */
  OPT_mno_custom_fmaxs = 1710,               /* -mno-custom-fmaxs */
  OPT_mno_custom_fmind = 1711,               /* -mno-custom-fmind */
  OPT_mno_custom_fmins = 1712,               /* -mno-custom-fmins */
  OPT_mno_custom_fmuld = 1713,               /* -mno-custom-fmuld */
  OPT_mno_custom_fmuls = 1714,               /* -mno-custom-fmuls */
  OPT_mno_custom_fnegd = 1715,               /* -mno-custom-fnegd */
  OPT_mno_custom_fnegs = 1716,               /* -mno-custom-fnegs */
  OPT_mno_custom_frdxhi = 1717,              /* -mno-custom-frdxhi */
  OPT_mno_custom_frdxlo = 1718,              /* -mno-custom-frdxlo */
  OPT_mno_custom_frdy = 1719,                /* -mno-custom-frdy */
  OPT_mno_custom_fsind = 1720,               /* -mno-custom-fsind */
  OPT_mno_custom_fsins = 1721,               /* -mno-custom-fsins */
  OPT_mno_custom_fsqrtd = 1722,              /* -mno-custom-fsqrtd */
  OPT_mno_custom_fsqrts = 1723,              /* -mno-custom-fsqrts */
  OPT_mno_custom_fsubd = 1724,               /* -mno-custom-fsubd */
  OPT_mno_custom_fsubs = 1725,               /* -mno-custom-fsubs */
  OPT_mno_custom_ftand = 1726,               /* -mno-custom-ftand */
  OPT_mno_custom_ftans = 1727,               /* -mno-custom-ftans */
  OPT_mno_custom_ftruncds = 1728,            /* -mno-custom-ftruncds */
  OPT_mno_custom_fwrx = 1729,                /* -mno-custom-fwrx */
  OPT_mno_custom_fwry = 1730,                /* -mno-custom-fwry */
  OPT_mno_custom_round = 1731,               /* -mno-custom-round */
  OPT_mno_gpopt = 1732,                      /* -mno-gpopt */
  OPT_mr0rel_sec_ = 1733,                    /* -mr0rel-sec= */
